...
class KotlinBootstrapBlueprintTests : CompatSpec({
    ...
    test("Bootstrap app project (multi-project)") {
        ...
        projectDir.resolve("app/detekt-config.yml").shouldExist()
        projectDir.resolve("app/README.md").shouldExist()
        projectDir.resolve("app/LICENSE").shouldExist()
        projectDir.resolve("app/project.properties").shouldExist()
    ...
    test("Bootstrap lib project (multi-project)") {
        ...
        projectDir.resolve("lib/detekt-config.yml").shouldExist()
        projectDir.resolve("lib/README.md").shouldExist()
        projectDir.resolve("lib/LICENSE").shouldExist()
        projectDir.resolve("lib/project.properties").shouldExist()
    }
})
