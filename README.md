...
- [Bootstrap new projects](#bootstraping)
...
- [Add support for integration and funtional testing](#test-improvements)
...
|---|---|---|---|
| [bootstrap](#bootstraping) | Bootstraps app/lib project | - | - |
...
| [uberJar](#packaging) | Creates Uber-JAR (applicatons only) | - | [Gradle Shadow Plugin](https://plugins.gradle.org/plugin/com.github.johnrengelman.shadow) |
...
- `withJacococ`: Generates [JaCoCo](https://www.jacoco.org/jacoco/) code coverage reports after tests. They can be found under _build/reports/jacoco/_.
...
The overriden configuration must be placed inside the preset block. Following will **NOT** work:
...
### Version main-SNAPSHOT (2022-12-28)
...
- Deprecate `kradle-app` and `kradle-lib`
